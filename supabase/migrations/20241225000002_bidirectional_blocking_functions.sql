-- Bidirectional Blocking for Search and Suggested Users Functions
-- This migration updates search_users and get_suggested_users to filter out users who have blocked the current user

-- Update search_users function to filter bidirectionally
...
-- Update get_suggested_users function to filter bidirectionally
...
-- Add comments explaining the bidirectional blocking
COMMENT ON FUNCTION search_users IS
  'Searches for users by name, excluding users that the current user has blocked AND users who have blocked the current user (bidirectional blocking).';

COMMENT ON FUNCTION get_suggested_users IS
  'Returns suggested users based on mutual connections and engagement, excluding users in both blocking directions (bidirectional blocking).';
